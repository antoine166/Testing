...
import { type Task, type TaskDomain, type TaskPriority, type TaskEnergy, type TaskProject } from "@/components/task-row";
...
type InboxCaptureFormProps = {
  ...
  createTask: (input: Record<string, unknown>) => Promise<Task | null>;
