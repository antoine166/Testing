    ...
    <div className="mx-auto w-full max-w-2xl flex-1 px-4 py-6 sm:py-10">
      ...
      <div className="mb-6 rounded-lg border border-zinc-200 p-4 dark:border-zinc-800">
        ...
        <p className="mt-1 text-sm text-zinc-500">
          Connect your Gmail account so forwarded emails (3.1a) get linked back to the
          original message in Gmail automatically, instead of relying on a link pasted
          into the forward. Read-only — Life OS never reads message content, only looks
          up a message&apos;s ID by the Message-ID it already captures.
        </p>
        {!isGmailConfigured() ? (
